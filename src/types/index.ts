...
export { IServerChangePasswordParams, IServerChangePasswordResponse } from './windows/change-password';
export { IServerScaleParams, IServerScaleResponse } from './windows/scale';
